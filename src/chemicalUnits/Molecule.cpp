...
void Molecule::toGJF(string fileName, string method, string basis, string addKeywords, string midKeywords, string endKeywords, int charge, int multiplicity, bool zmatrix, vector<double> EField, vector<int> bondFixer, int modHF, int mem, int procs)
{    
    ...
    ofstream file;
    file.open(fileName);
    file << "%nprocshared=" << procs << endl;
    file << "%mem=" << mem << "GB" << endl;
