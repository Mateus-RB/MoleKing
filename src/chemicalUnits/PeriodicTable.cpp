...
PeriodicTable::PeriodicTable(){
    ...
    this->ColorMap.insert(pair<string, string>("C", "909090"));
    ...
    this->ColorMap.insert(pair<string, string>("Ga", "C28F8F"));
    this->ColorMap.insert(pair<string, string>("Ge", "668F8F"));
    this->ColorMap.insert(pair<string, string>("As", "BD80E3"));
    this->ColorMap.insert(pair<string, string>("Se", "FFA100"));
    this->ColorMap.insert(pair<string, string>("Br", "A62929"));
    this->ColorMap.insert(pair<string, string>("Kr", "5CB8D1"));
    this->ColorMap.insert(pair<string, string>("Rb", "702EB0"));
    this->ColorMap.insert(pair<string, string>("Sr", "00FF00"));
